...
fun init(sqLiteDatabase: SQLiteDatabase) {
    ...
    values.put(TABLES.STATUS.COL_VALUE, 0.003f)
    sqLiteDatabase.insert(TABLES.STATUS.TAB_NAME, null, values)
    values.clear()
    values.put(TABLES.STATUS.COL_KEY, TABLES.STATUS.keys.GOLD_CHANCE)
    values.put(TABLES.STATUS.COL_VALUE, 0.03f)
    sqLiteDatabase.insert(TABLES.STATUS.TAB_NAME, null, values)
    values.clear()
    ...
    // Tracks
    values.put(TABLES.TRACK.COL_ID, "Diviners & Azertion - Feelings")
    values.put(TABLES.TRACK.COL_COST, 0)
    values.put(TABLES.TRACK.COL_PURCHASED, 1)
    values.put(TABLES.TRACK.COL_SRC, "Diviners & Azertion - Feelings")
    sqLiteDatabase.insert(TABLES.TRACK.TAB_NAME, null, values)
    values.clear()
    values.put(TABLES.TRACK.COL_ID, "Max Brhon - Cyberpunk")
    values.put(TABLES.TRACK.COL_COST, 100)
    values.put(TABLES.TRACK.COL_PURCHASED, 0)
    values.put(TABLES.TRACK.COL_SRC, "Max Brhon - Cyberpunk")
    sqLiteDatabase.insert(TABLES.TRACK.TAB_NAME, null, values)
    values.clear()
    values.put(TABLES.TRACK.COL_ID, "Oneeva - Platform 9")
    values.put(TABLES.TRACK.COL_COST, 100)
    values.put(TABLES.TRACK.COL_PURCHASED, 0)
    values.put(TABLES.TRACK.COL_SRC, "Oneeva - Platform 9")
    sqLiteDatabase.insert(TABLES.TRACK.TAB_NAME, null, values)
    values.clear()
    values.put(TABLES.TRACK.COL_ID, "Alan Walker - Fade")
    values.put(TABLES.TRACK.COL_COST, 200)
    values.put(TABLES.TRACK.COL_PURCHASED, 0)
