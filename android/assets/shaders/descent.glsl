...
void main()
{
    ...
    float color=-1.0*cos(PI*position.x*2.0)+1.0*sin(PI*position.y);
    gl_FragColor=vec4(vec3((c*t+t)*0.5*value+color,c*1.5-t*0.025,c*1.25-t*0.0125*value-color)*c,1.0);
}